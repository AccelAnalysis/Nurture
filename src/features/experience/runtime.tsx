...
export interface ExperienceOperationSource {
  execute(request: { organizationId?: string; experienceId: string; moduleId: string; operation: string; requestId: string }): Promise<JsonObject>;
}
const unavailableOperations: ExperienceOperationSource = { async execute() { throw new Error("Protected operations are unavailable."); } };
