...
export interface IntegrationRequestContext {
  /** Organization scope requested by the application. Trusted code must verify it. */
  organizationId?: string;
  correlationId: string;
  /** Required for financial, communication, reward, or other repeat-sensitive work. */
...
/** SendGrid remains an implementation detail behind this application port. */
...
/** Twilio remains an implementation detail behind this application port. */
...
/** Firebase Storage is consumed through this boundary rather than feature SDK calls. */
...
/** Track F supplies the event envelope; Track E owns the provider boundary. */
...
/**
 * Trusted backend authentication port. Browser code obtains Firebase ID tokens;
 * privileged services verify them server-side and derive the principal here.
 */
