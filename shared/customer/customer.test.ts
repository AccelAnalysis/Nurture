...
import { stableCustomerIdForIdentity } from "./identity.js";
import {
...
import type { LegacyIdentityOnboardingState, OnboardingFlowDefinitionV2, OnboardingProgressScope } from "./contracts.js";
...
describe("Release 2 Track C customer foundation", () => {
  ...
  it("pins an in-progress flow and records completion exactly once", () => {
