...
/**
 * Feature/domain code may construct this request, but trusted server code must
 * derive the final actor, authoritative time, and source before persistence.
 */
...
/** Defense-in-depth sanitizer. Raw credentials must never enter audit input. */
